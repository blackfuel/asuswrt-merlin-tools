#!/bin/bash
MERLIN_TARGET="asuswrt-merlin.382"
cd
...
diff -u -B -N ./${MERLIN_TARGET}-original/release/src/router/rc/rc.c ./${MERLIN_TARGET}/release/src/router/rc/rc.c >> merlin-diff.patch
diff -u -B -N ./${MERLIN_TARGET}-original/release/src/router/rc/rc.h ./${MERLIN_TARGET}/release/src/router/rc/rc.h >> merlin-diff.patch
diff -u -B -N ./${MERLIN_TARGET}-original/release/src/router/rc/init.c ./${MERLIN_TARGET}/release/src/router/rc/init.c >> merlin-diff.patch
...
diff -u -B -N ./${MERLIN_TARGET}-original/release/src/router/rc/watchdog.c ./${MERLIN_TARGET}/release/src/router/rc/watchdog.c >> merlin-diff.patch
diff -u -B -N ./${MERLIN_TARGET}-original/release/src/router/shared/shared.h ./${MERLIN_TARGET}/release/src/router/shared/shared.h >> merlin-diff.patch
...
diff -u -B -N ./${MERLIN_TARGET}-original/release/src/router/shared/scripts.c ./${MERLIN_TARGET}/release/src/router/shared/scripts.c >> merlin-diff.patch
...
diff -u -B -N ./${MERLIN_TARGET}-original/release/src/router/busybox-1.24.1/busybox-1.24.1/config_base ./${MERLIN_TARGET}/release/src/router/busybox-1.24.1/busybox-1.24.1/config_base >> merlin-diff.patch
