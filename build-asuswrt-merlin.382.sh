...
echo "\`Tor 0.3.3.9, NTP 4.2.8p11, DNSCrypt 1.9.5, Curl 7.61.0, Wget 1.19.5, Cryptsetup 2.0.4, Wipe 2.3.1, Whois 5.3.2, Findutils 4.6.0, Apcupsd 3.14.14, Powstatd 1.5.1, Haveged 1.9.1, Rngtools 5, Rtl-entropy, RTL-SDR, Dieharder 3.31.1, Xtables-Addons\`" >>"$NOTES"
echo >>"$NOTES"
fi
